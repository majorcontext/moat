...
```bash
agent run examples/claude-code -- npx @anthropic-ai/claude-code
```
...
```bash
# Analyze the code
agent run examples/claude-code -- npx @anthropic-ai/claude-code --print "what does this code do?"

# Fix the bug
agent run examples/claude-code -- npx @anthropic-ai/claude-code --print "fix the bug in main.py"
```
